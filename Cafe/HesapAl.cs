...
namespace Cafe
{
    public partial class HesapAl : Form
    {
        ...
        private void btnSodexo_Click(object sender, EventArgs e)
        {
            ...
            OdemeTipi = btn.Text;
            cSiparisUrunler su = new cSiparisUrunler();
            bool sonuc = su.HesapGuncelleByOdendi(lvFis);//liste gönderilip içindeki SiparisUrunler Id leri okunuyor ve onlara göre siparişlerin durumu ödendi olarak değiştiriliyor ve liste bidaha gösterilmiyor.
            if (sonuc)
            {
